  ...
  return (
    <Card>
      <CardHeader>
        ...
        <span className="text-xs text-muted-foreground">Synthetic trend preview</span>
      </CardHeader>
      <CardContent>
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={telemetry}>
              ...
              <YAxis stroke="#64748b" />
              <Tooltip contentStyle={{ background: "hsl(var(--panel))", border: "1px solid hsl(var(--border))", color: "hsl(var(--foreground))" }} />
