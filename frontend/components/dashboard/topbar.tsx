...
import { ChevronDown, Database, LogOut, Radar, ServerCog } from "lucide-react";
...
export function Topbar({ user }: { user: User | null }) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-border bg-panel/82 px-4 py-3 backdrop-blur-xl lg:px-8">
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="hidden min-w-0 lg:block">
          <div className="text-sm font-medium text-foreground">Synthetic radar operations console</div>
        ...
        <div className="flex items-center gap-2">
          ...
          <details className="group relative">
            <summary className="flex cursor-pointer list-none items-center gap-2 rounded-md px-2 py-1.5 transition hover:bg-muted">
            ...
            <div className="absolute right-0 top-12 z-40 w-56 rounded-lg border border-border bg-panel p-2 shadow-glow">
